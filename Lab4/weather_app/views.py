...
FORECASTS = [
    {'id': 1, 'city_id': 1, 'datetime': '2021-10-10 12:00:00', 'forecasted_temperature': '20',
     'forecasted_humidity': '50'},
    {'id': 2, 'city_id': 1, 'datetime': '2021-10-11 12:00:00', 'forecasted_temperature': '21',
     'forecasted_humidity': '51'},
    {'id': 3, 'city_id': 2, 'datetime': '2021-10-10 12:00:00', 'forecasted_temperature': '22',
     'forecasted_humidity': '52'},
    {'id': 4, 'city_id': 2, 'datetime': '2021-10-11 12:00:00', 'forecasted_temperature': '23',
     'forecasted_humidity': '53'},
    {'id': 5, 'city_id': 3, 'datetime': '2021-10-10 12:00:00', 'forecasted_temperature': '24',
     'forecasted_humidity': '54'},
    {'id': 6, 'city_id': 3, 'datetime': '2021-10-11 12:00:00', 'forecasted_temperature': '25',
...
def add_city(request):
    if request.method == 'POST':
        ...
        country = next((country for country in COUNTRIES if country['id'] == int(country_id)), None)
        id = len(CITIES) + 1
...
def edit_forecast(request, forecast_id):
    if request.method == 'GET':
        forecast = next((forecast for forecast in FORECASTS if forecast['id'] == int(forecast_id)), None)
        return render(request, 'edit_forecast.html', {'forecast': forecast, 'cities': CITIES})
...
def create_forecast(request):
    if request.method == 'GET':
        ...
        id = len(FORECASTS) + 1
        forecast = {'id': id, 'city_id': city['id'], 'datetime': forecast_datetime,
...
def get_forecast(request, city_name):
    if request.method == 'GET':
        ...
        forecasts = [forecast for forecast in FORECASTS if forecast['city_id'] == city['id']]  # .....
